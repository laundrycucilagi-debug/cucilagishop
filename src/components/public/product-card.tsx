  ...
  return (
    <article className="flex h-full flex-col rounded-[20px] border border-black/10 bg-white p-2.5 shadow-card transition duration-200 hover:-translate-y-1 hover:shadow-strong sm:p-3.5 lg:p-[22px]">
      ...
      <div className="flex flex-1 flex-col">
        ...
        <div className="mt-auto min-h-[3.2rem] pt-3 lg:min-h-[4.35rem] lg:pt-4">
          <div className="min-h-[0.72rem] sm:min-h-[0.82rem] lg:min-h-[1rem]">
            {hasDiscount ? (
              <p className="truncate text-[0.64rem] font-bold leading-none text-muted-text line-through sm:text-xs lg:text-sm">
        ...
        <div className="w-full pt-3 lg:pt-[18px]">
          {isEmpty ? (
